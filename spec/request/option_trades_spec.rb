...
describe 'OptionTrades', type: :request do
  it 'creates a call option trade' do
    post '/option_trades', headers: {'ACCEPT' => 'application/json'}, params: {option_trade: {action: 'call', strike: 10.0, premium: 1.0}}
  ...
  it 'creates a put option trade' do
    post '/option_trades', headers: {'ACCEPT' => 'application/json'}, params: {option_trade: {action: 'put', strike: 10.0, premium: 1.0}}
